...
exports.sendUnderReviewNotice = sendUnderReviewNotice;
exports.sendApprovalEmail = sendApprovalEmail;
exports.sendRejectionEmail = sendRejectionEmail;
exports.sendAdminNewApplicationAlert = sendAdminNewApplicationAlert;
...
async function sendUnderReviewNotice(opts) {
    await sendEmail({
        to: opts.to,
...
async function sendAdminNewApplicationAlert(opts) {
    await sendEmail({
        to: ADMIN_EMAIL,
