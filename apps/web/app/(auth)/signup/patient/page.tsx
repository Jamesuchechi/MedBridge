...
export default function PatientSignupPage() {
  ...
  return (
    <AuthLayout
      headline="Healthcare built for Africa"
      headlineHighlight="Africa"
    ...
    >
      <div className="auth-form-header">
        ...
        <p>Already have one? <Link href="/login" style={{ color: 'var(--accent)', fontWeight: 600 }}>Sign in instead</Link></p>
      </div>
      ...
      <form className="auth-form" onSubmit={handleSubmit}>
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
          <Link href="/signup" className="auth-btn" style={{ width: "auto", background: "var(--glass)", display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <ArrowLeftIcon />
          </Link>
